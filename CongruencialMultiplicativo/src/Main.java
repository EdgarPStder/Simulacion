...
public class Main extends JFrame {
    private JTextField semillaField, cantidadField, constanteaField, moduloField;
    private JTable resultadoTabla;
    private DefaultTableModel tableModel;

    public Main() {
        setTitle("Generador de Números Pseudoaleatorios - Congruencial Multiplicativo");
        setSize(700, 400);
        ...
        tableModel = new DefaultTableModel(new String[]{"X", "(a*X)mod(m)", "Resultado", "Division", "r"}, 0);
    ...
    private void generarNumeros() {
        try {
            ...
            for (int i = 0; i < cantidad; i++) {
                // Generación de número aleatorio según la fórmula (a * X) mod m
                Xi = (a * Xi) % m;
                ...
                tableModel.addRow(new Object[]{Xi, "(" + a + "*" + Xi + ") mod " + m, Xi, Xi+"/"+(m-1), riRedondeado});
            }
